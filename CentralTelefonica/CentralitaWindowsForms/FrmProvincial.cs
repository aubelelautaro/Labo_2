...
namespace CentralitaWindowsForms
{
    public partial class FrmProvincial : FrmLlamada
    {
        ...
        {
            InitializeComponent();
            this.cboFranja.DataSource = Enum.GetValues(typeof(EFranja));
        }
        ...
        protected override void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            this.miLlamada = new Provincial(this.txtNumeroOrigen.Text, (EFranja)this.cboFranja.SelectedItem, duracion, this.txtNumeroDestino.Text);
